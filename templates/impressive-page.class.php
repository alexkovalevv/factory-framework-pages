...
if ( ! class_exists( 'Wbcr_FactoryPages000_ImpressiveThemplate' ) ) {
	...
	abstract class Wbcr_FactoryPages000_ImpressiveThemplate extends Wbcr_FactoryPages000_AdminPage {
		...
		public function getPluginTitle() {
			 ...
			 */
			$plugin_title = wbcr_factory_000_apply_filters_deprecated( 'wbcr/factory/imppage/plugin_title', [
		...
		public function flushCacheAndRulesAction() {
			 ...
			 */
			wbcr_factory_000_do_action_deprecated( 'wbcr_factory_000_imppage_flush_cache', [
				$this->plugin->getPluginName(),
				$this->getResultId()
			 ...
			 * @since 4.0.9 - является устаревшим
			 */
			wbcr_factory_000_do_action_deprecated( 'wbcr_factory_000_imppage_after_form_save', [
				$this->plugin,
				$this
		...
		protected function printAllNotices() {
			 ...
			 * @since 4.0.9 - является устаревшим
			 */
			wbcr_factory_000_do_action_deprecated( 'wbcr_factory_pages_000_imppage_print_all_notices', [
				$this->plugin,
				$this
		...
		private function showActionsNotice() {
			 ...
			 * @since 4.0.9 - является устаревшим
			 */
			$notices = wbcr_factory_000_apply_filters_deprecated( 'wbcr_factory_pages_000_imppage_actions_notice', [
				$notices,
				$this->plugin,
				$this->id
		...
		protected function showOptions() {
			...
			if ( isset( $_POST[ $this->plugin->getPluginName() . '_save_action' ] ) ) {
				 ...
				 * @since 4.0.9 - является устаревшим
				 */
				wbcr_factory_000_do_action_deprecated( 'wbcr_factory_000_imppage_before_form_save', [
					$form,
					$this->plugin,
					$this
				 ...
				 * @since 4.0.9 - является устаревшим
				 */
				wbcr_factory_000_do_action_deprecated( 'wbcr_factory_000_imppage_form_saved', [
					$form,
					$this->plugin,
					$this
